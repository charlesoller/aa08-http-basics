...
Request components:
- Method: GET
- URL:  /(anything we don't have a page for)
- Headers: none
- Body: none
...
- Status code: 404
- Headers: none
- Body: Error code page not found

ACTUAL: Response components:
- Status code: 404
- Headers: Content-Type: text/html
- Body: Error code page not found (still included nav)
...
- Status code: 200
- Headers: content-type: html
- Body: html form to add a new product
